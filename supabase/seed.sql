...
insert into public.locais_pesca (nome, regiao, nivel, guia, pais, lat, lng, preco_viagem, diaria, lic_3dias, lic_7dias, lic_ilimitada, estimado) values
  ('Rio Mudwater', 'Missouri, EUA', 'Nível 1+', 'Água inicial dos EUA, ótima para missões de bass e panfish. Boia leve com minhoca/maggot para os panfish; iscas artificiais com twitching rápido no amanhecer e entardecer para bass e pickerel.', 'EUA', 38.5, -92.5, 2000, 500, null, null, null, false),
  ('Pesqueiro Lesni Vila', 'República Tcheca', 'Nível 1+ (águas tchecas)', 'Pesqueiro tcheco para iniciantes. Bloodworm no anzol #10 pega quase todas as espécies. Boias deslizantes (slip bobber) ajudam muito em carpa, tenca e bagre.', 'República Tcheca', 49.8, 15.47, null, null, null, null, null, false),
